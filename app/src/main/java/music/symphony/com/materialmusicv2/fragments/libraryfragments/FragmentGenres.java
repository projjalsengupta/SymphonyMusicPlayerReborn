...
import music.symphony.com.materialmusicv2.adapters.GenreAdapter;
    ...
    private void loadGenres() {
        ...
        AsyncTask.execute(() -> {
            ...
            new Handler(Looper.getMainLooper()).post(() -> {
                ...
                if (genres != null && !genres.isEmpty() && recyclerView != null) {
                    if (genreAdapter == null) {
                        genreAdapter = new GenreAdapter(genres, getActivity());
                        recyclerView.setAdapter(genreAdapter);
                    } else {
                        genreAdapter.changeGenres(genres);
                    }
                }
